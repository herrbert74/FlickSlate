...
class DeleteTvShowEpisodeRatingUseCase @Inject internal constructor(
	private val getSessionIdUseCase: GetSessionIdUseCase,
	private val tvRatingsRepository: TvRatingsRepository,
) {

	suspend fun execute(tvShowId: Int, seasonNumber: Int, episodeNumber: Int): Outcome<Unit> {
		return getSessionIdUseCase.execute()
			.andThen { sessionId ->
				tvRatingsRepository.deleteTvShowEpisodeRating(tvShowId, seasonNumber, episodeNumber, sessionId)
			}
	}
}
